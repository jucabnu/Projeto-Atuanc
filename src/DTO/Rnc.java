...
public class Rnc {
    ...
    public Rnc(int numrnc, int codusu, Timestamp datreg, Timestamp datini, Timestamp datalt, int altusu, String resfim, Timestamp datfim, int situacao, String idecau, String oricau, String clifor, String proser, int codset, float qtdrnc, int numnfe, String numfal, int codmot, boolean labind, String disind, float valind, String areind, String resind) {
        this.numrnc = numrnc;
        this.codusu = codusu;
        this.datreg = datreg;
        this.datini = datini;
