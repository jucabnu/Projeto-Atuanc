...
import TelasPesquisa.PesquisaSetor;
 ...
 * @author jucabnu
 */
public class CrudSetor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelCPF.setText("Código do Setor:");

        jLabelNome.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        jLabelNome.setText("Descrição do Setor:");
    ...
    private void botaoGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoGravarActionPerformed
        ...
        try {
            if (campoCodigo.getText().equals("")) {
                ...
                s = DAOSetor.getSetorPeloCod(Integer.parseInt(campoCodigo.getText()));                
                
            }
            
            if (s.getNomset().equals("")) {
                
                // GRAVAR : INSERT
                Setor se = new Setor();                              
                se.setNomset(campoDescricao.getText());                
                DAOSetor.inserir(se);                  
                ...
                Setor se = new Setor();
                se.setCodset(Integer.parseInt(campoCodigo.getText()));
                se.setNomset(campoDescricao.getText());
                DAOSetor.atualizar(se);
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        try {
            DAOSetor.deletar(Integer.parseInt(campoCodigo.getText()));            
    ...
    private void botaoPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPesquisarActionPerformed
        ...
        PesquisaSetor tela = new PesquisaSetor();
        tela.instancia(this);
    ...
    private void campoCodigoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_campoCodigoFocusLost
        ...
        try {
            if (campoCodigo.getText().equals("")) {
                ...
                Setor s = DAOSetor.getSetorPeloCod(Integer.parseInt(campoCodigo.getText()));
                campoDescricao.setText(s.getNomset());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrudSetor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
